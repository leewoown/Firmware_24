...
void InitGpio(void)
{
  ...
  // GpioCtrlRegs.GPAMUX1.all = 0x0000;     // GPIO functionality GPIO16-GPIO31
   ...
   GpioCtrlRegs.GPAMUX2.bit.GPIO20=QEPA;
   ...
   GpioCtrlRegs.GPAMUX2.bit.GPIO30=3;
   GpioCtrlRegs.GPAMUX2.bit.GPIO31=3;
...
//   GpioCtrlRegs.GPAMUX2.bit.GPIO31=CANTX;
  ...
  // GpioCtrlRegs.GPBMUX1.all = 0x0000;     // GPIO functionality GPIO32-GPIO44
   ...
   GpioCtrlRegs.GPADIR.bit.GPIO16=OUTPUT;
   GpioCtrlRegs.GPADIR.bit.GPIO17=OUTPUT;
   GpioCtrlRegs.GPADIR.bit.GPIO18=OUTPUT;
   GpioCtrlRegs.GPADIR.bit.GPIO19=OUTPUT;
   GpioCtrlRegs.GPADIR.bit.GPIO20=INPUT;   //QEPA
   GpioCtrlRegs.GPADIR.bit.GPIO21=OUTPUT;  //INPUT;	//QEPB
   GpioCtrlRegs.GPADIR.bit.GPIO22=INPUT;   //OUTPUT;
